...
class _banveState extends State<banve> {
            ...
            children: [
              ...
              Row(
                ...
                GestureDetector(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.white,
                      border: cash==true? Border.all(color: Colors.blue, width: 2):null,
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.white,
                      border: bank==true?Border.all(color: Colors.blue, width: 2): Border.all(color: Colors.grey[200], width: 2),
                      borderRadius: BorderRadius.circular(5),
                        boxShadow: [
                        BoxShadow(
                          color: Colors.black.withOpacity(0.12),
                  ...
                  child:
                    SvgPicture.asset('asset/icons/vietinbank logo svg.svg')
  ...
  bool xacnhan(){
    if(ve== null || ve.isEmpty){
      ...
      return false;
    } else  if(giave== null || giave.isEmpty){
      return false;
    } else return true;
  }
}
